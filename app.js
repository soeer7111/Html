...
let unsubscribeChat; 
let unsubscribeUsers; // Admin Panel User Listener အတွက်

// 💡 Helper: Firestore တွင် User Data သိမ်းခြင်း (Admin Panel အတွက် မရှိမဖြစ်လိုအပ်)
...
window.handleRegister = async () => {
    ...
    try {
        ...
        // 💡 ပြင်ဆင်ချက်: Firestore တွင် User ကို သိမ်းဆည်းခြင်း
...
window.handleLogout = async () => {
    try {
        ...
        // 💡 Logout လုပ်ရင် Admin Panel listener ကို ဖြုတ်ပါ
...
window.uploadProfilePhoto = async () => {
    ...
    // 💡 ရုပ်ပုံမှ မြင်ရသည့်အတိုင်း Billing ပြဿနာကို ထည့်ထားသည်
...
// 💡 ပြင်ဆင်ချက်: Dropbox link များကို ပြန်လည် ထည့်သွင်း/စစ်ဆေးသည်။ (mpq -> mp4)
let videos = [
    { 
        id: 1, 
    ...
    { 
        ...
        download: 'https://www.dropbox.com/scl/fi/zglupxm7oaa1xzfzlf427/VID_20251108_164004_870.mp4?rlkey=pe5pxns9stqmzz2hg2lxpjxnu&st=irvwtia2&dl=1', // 💡 mpq ကို mp4 ပြန်ပြင်သည်။
        currentLikes: 8, 
        userLiked: false, 
        currentComments: []
    }
...
window.checkAdminStatus = () => {
    ...
    if (adminMessage) adminMessage.textContent = 'Checking admin permissions...';

    if (user && user.email === ADMIN_EMAIL) {
        if (adminMessage) adminMessage.textConten
