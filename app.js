...
// ✅ Storage ကို Photo Upload အတွက် ထည့်သွင်းလိုက်ပါ
...
// =================================================
// 🚨 Part 4: Profile Page Logic & All User Update Functions (Admin Button Logic ပြင်ဆင်)
// =================================================

// ⚠️ Admin Email ကို ဒီမှာပါ ခေါ်သုံးရန် (Global Variable ဖြစ်သော်လည်း Error ရှောင်ရန်)
// (Part 1 တွင် သတ်မှတ်ပြီးသား ဖြစ်သော်လည်း ဒီနေရာတွင် ထပ်သုံးပါမည်)
const ADMIN_EMAIL = 'soeer71@dummy.com'; 
...
window.loadProfileData = () => {
    ...
    // ✅ Admin Button ကို စစ်ဆေးပြီး ပြသခြင်း (Admin Panel အလုပ်လုပ်စေရန်)
...
// ... (changeUsername, uploadProfilePhoto, sendPasswordResetEmail functions များ မပြောင်းလဲပါ)
// ... (သင်ယခင်က ပြင်ဆင်ထားသော Part 4 Code အောက်ပိုင်းကို ဆက်ထားပါ)
...
// =================================================
// 🚨 Part 7: Admin Panel Logic (Final Working Version - Global Error ဖြေရှင်း)
// =================================================

// 💡 Helper Function: User Data ကို Firestore ထဲသိမ်းဆည်းရန် (မပြောင်းလဲပါ)
...
window.loadUserList = async () => {
    // ⚠️ Note: checkAdminStatus() က Admin Page မှ ခေါ်မှသာ UI ကို update လုပ်ပါမည်
    const userList = document.getElementById('user-list');
    if (!userList) return; // ✅ Admin List element မရှိရင် ဘာမှ မလုပ်ပါ
    
    if (!checkAdminStatus()) {
        userList.innerHTML = '<li>Admin ခွင့်ပြုချက် မရှိပါ။</li>';
        return;
    } 
