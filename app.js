...
function showPage(pageId) {
    ...
    if (navBar) {
        if (pageId === 'home-page' || pageId === 'profile-page' || pageId === 'admin-page') {
            // home, profile, admin page များတွင်သာ nav bar ကို ပြသည် (login/register မှလွဲ၍)
...
// =================================================
// ✅ Part 3: Authentication (Login/Register/Logout/State Check) (FINAL FIX 2 - Login State)
// =================================================
...
window.auth.onAuthStateChanged((user) => {
    ...
    if (user) {
        ...
        // 🚨 FIX: Login မဝင်ထားသူများအတွက်၊ login-page ကို တိုက်ရိုက် ပြန်ပို့သည်။
        showPage('login-page');
        if (unsubscribeChat) unsubscribeChat(); 
        if (unsubscribeUsers) unsubscribeUsers(); 
    }
