...
// =================================================
// ✅ Part 3: Authentication (Login/Register/Logout/State Check) (FINAL FIX 7 - Functionality Restoration)
// =================================================
...
window.auth.onAuthStateChanged((user) => {
    ...
    if (user) {
        ...
        // 🚨 FIX 7: Functionality Restoration - ၎င်းတို့ကို onAuthStateChanged မှာ ချက်ချင်းခေါ်ပါ။
        initializeVideoPlayer(); 
        loadProfileData(); 
        // -------------------------------------------------------------
...
window.loadProfileData = () => {
    ...
    if (!user) {
        // 💡 Login မဝင်ထားပါက Profile data များ မပြသရန် သေချာစေခြင်း
        document.getElementById('display-username').textContent = 'N/A';
        document.getElementById('display-email').textContent = 'N/A';
        document.getElementById('creation-date').textContent = 'N/A';
