...
function showPage(pageId) {
    ...
    if (pageId === 'home-page') {
        ...
        // Admin Logic များကို ဒီနေရာမှာ ခေါ်ရန်လိုအပ်ပါက ထည့်သွင်းနိုင်သည်
    }
}
...
window.handleRegister = async () => {
    ...
    // 💡 soeer71 ကို soeer71@dummy.com အဖြစ်ပြောင်းရန်
...
window.loadProfileData = () => {
    ...
    // 💡 Display Name ကို @dummy.com ဖြုတ်ပြီး ပြသခြင်း
...
function initializeVideoPlayer() {
    ...
    renderSidebar(); // ✅ Sidebar Rendering Function ကို ခေါ်ခြင်း
...
function loadVideo(video, index) {
    ...
    updateSidebarHighlight(); // ✅ Sidebar Highlight Function ကို ခေါ်ခြင်း
}
...
// 💡 Sidebar Video List များကို Render လုပ်ခြင်း (ယခင်က ပျောက်ဆုံးခဲ့သည်)
...
// 💡 လက်ရှိဖွင့်ထားသော Video ကို Highlight လုပ်ခြင်း (ယခင်က ပျောက်ဆုံးခဲ့သည်)
...
// 💡 Next/Prev Button Functions (ယခင်က ပျောက်ဆုံးခဲ့သည်)
window.nextVideo = () => {
    currentVideoIndex++;
    if (currentVideoIndex >= videos.length) {
        currentVideoIndex = 0; // ပတ်လည်လည်စေရန်
    }
    loadVideo(videos[currentVideoIndex], currentVideoIndex);
};
