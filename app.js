...
function showPage(pageId) {
    ...
    // Header ကို Login/Register Pages တွင် ဝှက်ထားခြင်း
...
window.auth.onAuthStateChanged((user) => {
    // Loading Page ကို ပိတ်ပြီး သက်ဆိုင်ရာ Page ကို ပြသသည်
...
// 💡 MediaFire Link ကို Video 1 & 2 အတွက် အစားထိုးထားသည်
let mediaFireLink = 'https://download2285.mediafire.com/e6w0xns4olkgqf58wWvPLniykI0hY48zWD3PFlqPl_ZJ0419p96tay2TFwvGobbKaHrw5gAPL2Eh-yYb7tuAO6vio6nPlTemPrg3OtHeHeUY-6goBDQrJFKIpmYs5irC92fefYCLbbRvu3ROYq9Qe2oEmrMDtyhSn1BPmy43NM0/ep6gqdvvjkpdaos/5_6208271644641729117.mp4';
...
let videos = [
    ...
    { 
        id: 2, 
        url: mediaFireLink, // Link တူပေမယ့် စမ်းသပ်ဖို့ ထည့်ထားပါတယ်။
        title: 'Thai Schoolgirl showing off her fake tits (TEST LINK)', 
        download: mediaFireLink,
        currentLikes: 15, 
        userLiked: false, 
        currentComments: []
...
function loadDataFromStorage() {
    ...
    if (storedData) {
        ...
        // Data structure 2 ခုထက် နည်းရင် သို့မဟုတ် ခေါင်းစဉ် မတူရင် ရှင်းထုတ်ပါ
...
function initializeVideoPlayer() {
    ...
    if (!player) {
        // Video Player ကို initialize လုပ်ခြင်း
...
function loadVideo(video, index) {
    ...
    // Video Player Source အစားထိုးခြင်း
...
function renderComments(video) {
    ...
    const currentUsername = currentUser ? (currentUser.email.includes('@dummy.com') ? currentUser.email.replace('@dummy.com', '') : user.email.split('@')[0]) : 'Guest';
...
function renderSidebar() {
    ...
    videos.forEach((video, index) => {
        ...
        // Click Listener (Video ကို Load လုပ်ရန်)
