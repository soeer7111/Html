...
// (ဤအပိုင်းကို ယခင်အတိုင်း ထားရှိထားပါသည်။)
// =================================================

// UI ဖွဲ့စည်းမှု Functions (Change: video-js.css ကို import လုပ်ထားလို့ မလိုအပ်ပါ။)
...
// Auth Listener (ယခင်အတိုင်း Session ကို ထိန်းထားသည်)
...
// Register (ယခင်အတိုင်း Verification ကို ကျော်လွှားသည်)
...
// 🚨 Initial Video Data (Dropbox link ကို ပိုပြီး stream ရမယ့် format နဲ့ ပြန်ထည့်ထားသည်)
let videos = [
    { 
        id: 1, // Add ID for persistence
        url: 'https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4', // Working video link for testing
    ...
    { 
        id: 2,
        url: 'https://www.dropbox.com/scl/fi/e3uu24s41eiar49ue6sky/1762078122323.mp4?rlkey=9w787qu03xhz3ssbq0a0q3288&raw=1', // Your Dropbox link with raw=1
        title: 'ထိုင်း‌ ကျောင်းသူမလေး လီးတုနဲ့လိုးပြနေသည် (Dropbox)', 
        download: 'https://www.dropbox.com/scl/fi/e3uu24s41eiar49ue6sky/1762078122323.mp4?rlkey=9w787qu03xhz3ssbq0a0q3288&raw=1', 
        currentLikes: 15, 
        userLiked: false, 
        currentComments: [
            { user: 'Admin', text: 'သူမစာ‌ကာမ အရသာကိုစာလောင်‌ နေပါသသည်!', timestamp: '2025-11-06 10:00' }
        ]
    },
];
...
function loadVideo(video, index) {
    ...
    // 🚨 Marquee effect အတွက် title ကို ပြောင်းပါ
...
window.addComment = () => {
    ...
    // User ကို အမည်မှန်ဖြင့် မှတ်စေရန်
