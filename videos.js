// =================================================
// 🚨 Firebase Authentication Logic (Final Version)
// =================================================
...
// videos.js ထဲက handleRegister function အသစ်
window.handleRegister = async () => {
    ...
    // username သီးသန့်ပေးပါက @dummy.com ဖြင့် ပေါင်းသည်
    const email = emailInput.includes('@') ? emailInput : `${emailInput}@dummy.com`; 

    // လျှို့ဝှက်နံပါတ် ၆ လုံးစစ်ဆေးသည်
    ...
    try {
        // 🚨 ၁။ User ကို Firebase တွင် ဖန်တီးသည်
        await window.createUserWithEmailAndPassword(window.auth, email, password);
        
        // 🚨 ၂။ User ကို ချက်ချင်း Login ပြန်ဝင်ခိုင်းသည်။ 
        // ၎င်းသည် Firebase က Email Verification စစ်တာကို ကျော်လွှားနိုင်မည်။
        await window.signInWithEmailAndPassword(window.auth, email, password);
        
        // ၃။ အောင်မြင်ပါက onAuthStateChanged က Home ကို ချက်ချင်း ပို့ပေးလိမ့်မည်
        messageDiv.textContent = 'မှတ်ပုံတင် အောင်မြင်ပါသည်။ ခဏစောင့်ပါ။'; 
        
    } catch (error) {
        // Error ဖြစ်ပါက စစ်ဆေးဖော်ပြသည်
...
// =================================================
// 🚨 Video Player Logic (ကျန်သော Code များ အတူတူ)
// =================================================
