...
window.handleRegister = async () => {
    ...
    try {
        ...
        // ၂။ အောင်မြင်တာနဲ့ ချက်ချင်း Login ပြန်ဝင်ခိုင်းသည်။ 
        // ၎င်းသည် Firebase က Email Verification စစ်တာကို ကျော်လွှားပေးနိုင်မည်။
        ...
        } else if (error.code === 'auth/weak-password') { // ထပ်ထည့်ထားသော Error စစ်ဆေးမှု
             messageDiv.textContent = 'လျှို့ဝှက်နံပါတ်က အားနည်းလွန်းပါတယ်။';
        } else {
