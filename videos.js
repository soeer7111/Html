...
// videos.js ထဲက handleLogin function ကို အစားထိုးပါ
window.handleLogin = async () => {
    ...
    messageDiv.textContent = 'ဝင်ရောက်နေပါသည်။ ကျေးဇူးပြု၍ စောင့်ဆိုင်းပါ။'; // Loading Start

    try {
        await window.signInWithEmailAndPassword(window.auth, email, password);
        // Login အောင်မြင်ပါက onAuthStateChanged က Home ကိုပို့မည်ဖြစ်၍ message ရှင်းစရာမလို။
        
    } catch (error) {
        // 🛑 Error ဖြစ်ရင် Message ကို ရှင်းပစ်ရမယ်
