...
window.onAuthStateChanged(window.auth, (user) => {
    if (user) {
        ...
        // Username သာ ပြသရန်အတွက် '@dummy.com' ကို ဖယ်ရှားလိုက်ပါသည်
...
window.handleRegister = async () => {
    ...
    // Firebase Auth မှာ Email ကို Username အဖြစ် သုံးရမည်။
    ...
    try {
        ...
        messageDiv.textContent = 'မှတ်ပုံတင် အောင်မြင်ပါသည်။ Home Page သို့ ရောက်ပါမည်။';
    } catch (error) {
